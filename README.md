...
2. $\textcolor{#f00}{\large  \textbf{NEW:}}$ **Calculate the required sample size** to achieve a $\textcolor{#f00}{\text{a \space high \space probability \space  \space of  \space a  \space model  \space with  \space acceptable  \space calibration}}$ (function **'samplesizedev'**)
